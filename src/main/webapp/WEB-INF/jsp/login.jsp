...
<div id="login-holder">
	...
	<!-- start logo -->
	<div id="logo-login">
		<a href="/login"><img src="images/shared/logo.png" width="156" height="40" alt="" /></a>
	</div>
	<!-- end logo -->
	...
	<div id="login-inner">
	 <form method="post" action="<c:url value="/auth" />">
		...
		<tr>
			<th></th>
			<td valign="top"><input type="checkbox" name="_spring_security_remember_me" class="checkbox-size" id="login-check" /><label for="login-check">Remember me</label></td>
		</tr>
		<tr>
			<th></th>
