...
<div id="page-heading"><h1>Modifier Formation</h1></div>
...
<tr>
	...
	<form:form  modelAttribute="formation" method="post" action="${pageContext.request.contextPath}/formation/update/${formation.id_formation}">
		<!-- start id-form -->
