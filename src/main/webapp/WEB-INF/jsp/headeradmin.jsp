...
<div class="nav-outer"> 
		...
		<li>
		<a  href="${pageContext.request.contextPath}/users/c/index">
		<b>Gestion des utilisateurs</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div  class="select_sub show">
			<ul class="sub">
				<li class="" onclick="showSub(this)"><a href="${pageContext.request.contextPath}/users/c/index">Collaborateur</a></li>
				<li class="" onclick="showSub(this)"><a href="${pageContext.request.contextPath}/users/f/index">Formateur</a></li>
				<li class="" onclick="showSub(this)"><a href="${pageContext.request.contextPath}/users/resp_f/index">Responsable de formation</a></li>
			</ul>
		</div>
		...
		<ul id="GM" class="select"><li><a   href="#nogo"><b>Gestion des emails</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub show">
			<ul class="sub">
				<li class="" onclick="showSub(this)"><a href="#nogo">Lister emails</a></li>
				<li class="" onclick="showSub(this)"><a href="#nogo">Modifier emails</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
		...
		<ul id="GC" class="select"><li><a   href="${pageContext.request.contextPath}/compte/index""><b>Gestion des comptes</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		...
		<ul id="GP" class="select"><li><a href="${pageContext.request.contextPath}/profile/index"><b>Gestion des profiles</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#nogo"></a></li>
		...
		<ul id="AP" class="select"><li><a   href="#nogo"><b>Assigner profiles à des actions</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="#nogo"></a></li>
