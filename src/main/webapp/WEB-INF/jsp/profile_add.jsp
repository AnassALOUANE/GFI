...
<div id="page-heading"><h1>Ajouter Profile</h1></div>
...
<tr>
	...
	<form:form  modelAttribute="profile" method="post" action="${pageContext.request.contextPath}/profile/add">
		<!-- start id-form -->
		<table border="0" cellpadding="0" cellspacing="0"  id="id-form">
		<tr>
			<th  valign="top"><form:label path="titre" class="athf" > <spring:message code="label.profile.titre"/> : </form:label></th>
