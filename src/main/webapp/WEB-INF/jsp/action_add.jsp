...
<html>
	...
	<body>
			...
			<h1>Assigner profile à des actions </h1>
        
        <form:form  modelAttribute="action" method="post" action="${pageContext.request.contextPath}/action/add"
                    onsubmit="return  confirmDelete('${pageContext.request.contextPath}/action/add')">
            ...
            <table>               
                ...
                <tr>
                    ...
                    <td><form:textarea path="desc" rows="5" cols="30" /></td>
