...
<div id="page-heading"><h1>Ajouter Collaborateur</h1></div>
...
<tr>
	...
	<form:form  modelAttribute="collaborateur" method="post" action="${pageContext.request.contextPath}/users/c/add">
		<!-- start id-form -->
