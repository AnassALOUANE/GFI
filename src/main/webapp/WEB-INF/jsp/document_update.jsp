...
<div id="page-heading"><h1>Modifier Document</h1></div>
...
<tr>
	...
	<td>
	 ...
	 <form:form   modelAttribute="document" method="post" action="${pageContext.request.contextPath}/${document.formation.id_formation}/document/update/${document.id_doc}"
