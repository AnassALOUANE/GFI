...
<!-- ############################################=here=############################################### -->
				<c:if test="${not empty collaborateurs}">
<!-- ############################################=END here=############################################### -->			
...
<!-- ############################################=here=############################################### -->
	            <c:forEach items="${collaborateurs}" var="c" >
	                <tr style="background-color: white; color: black; text-align: center;" height="40px">
						...
						<a href="${pageContext.request.contextPath}/users/c/delete/${c.id_u}" title="<spring:message code="label.supprimer"/>" class="icon-2 info-tooltip"></a>
						</td>
...
<!-- ############################################=here=############################################### -->
					<a href="${pageContext.request.contextPath}/users/c/add"><img src="<c:url value="/images/table/adduser.png"/>" /></a>
<!-- ############################################=END here=############################################### -->
